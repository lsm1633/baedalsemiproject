...
public class OrderListServlet extends MyServlet{
   ...
   protected void process(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
      ...
      if(uri.indexOf("orderlist.do")!=-1) {
         ...
         List<OrderListDTO> list = dao.orderList(userId,start,end);
      ...
      else if(uri.indexOf("orderlistadmin.do")!=-1) {
         // 게시물 리스트
         String page = req.getParameter("page");
         ...
         List<OrderListDTO> list = dao.orderListAdmin(start,end);
         ...
         listUrl=cp+"/orderlist/orderlistadmin.do";
         articleUrl=cp+"/orderlist/articleadmin.do?page="+current_page;
         ...
         forward(req, resp, "/WEB-INF/views/orderlist/orderlist.jsp");
       ...
       else if(uri.indexOf("articleadmin.do") != -1) {
            // 글보기
            ...
            OrderListDTO dto = dao.readOrderlist(orderNum);
            if(dto==null) {
               resp.sendRedirect(cp+"/orderlist/orderlistadmin.do?page=" + page);
               return;
            }   
