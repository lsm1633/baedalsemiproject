...
<body>
		...
		<div class="body-menu" align="center">
			<div class="row">
				<div class="col-lg-3 col-md-4 col-sm-5 col-xs-12 margin">
					...
					<div class="hovereffect ">
						<img class="img-responsive img-circle"
							src="<%=cp%>/res/images/chicken.png" alt="">
				...
				<div class="col-lg-3 col-md-4 col-sm-5 col-xs-12 margin">
					<div class="hovereffect ">
						<img class="img-responsive img-circle"
							src="<%=cp%>/res/images/pizza.png" alt="">
						<div class="overlay img-circle">
				...
				<div class="col-lg-3 col-md-4 col-sm-5 col-xs-12 margin">
					<div class="hovereffect ">
						<img class="img-responsive img-circle"
							src="<%=cp%>/res/images/bunsik.png" alt="">
						<div class="overlay img-circle">
				...
				<div class="col-lg-3 col-md-4 col-sm-5 col-xs-12 margin"
					...
					<div class="hovereffect ">
						<img class="img-responsive img-circle"
							src="<%=cp%>/res/images/jokbal.png" alt="">
						<div class="overlay img-circle">
				...
				<div class="col-lg-3 col-md-4 col-sm-5 col-xs-12 margin">
					<div class="hovereffect ">
						<img class="img-responsive img-circle"
							src="<%=cp%>/res/images/jungkukzip.png" alt="">
						<div class="overlay img-circle">
				...
				<div class="col-lg-3 col-md-4 col-sm-5 col-xs-12 margin">
					<div class="hovereffect ">
						<img class="img-responsive img-circle"
							src="<%=cp%>/res/images/hansik.jpg" alt="">
						<div class="overlay img-circle">
			...
			<div id="carousel-example-generic" class="carousel slide"
				...
				<div class="carousel-inner" role="listbox" align="center">
					<div class="item active">
						<a href="<%=cp%>/notice/article.do?${params}&num=1"> <img
							src="<%=cp%>/res/images/banner3.png" alt="배너1"></a>
						<div class="carousel-caption"></div>
					</div>
					<div class="item">
						<a href="<%=cp%>/notice/article.do?${params}&num=2"> <img
							src="<%=cp%>/res/images/banner4.png" alt="배너2"></a>
					</div>
					<div class="item">
						<a href="<%=cp%>/notice/article.do?${params}&num=3"> <img
	...
	<div class="container" role="main" style="margin-top: 30px">
		<!-- <div class="main-carousel" align="center"> -->
		<div class="col-xs-6">
			<h3 class="glyphicon glyphicon-bullhorn"> 공지사항</h3>
			<div style="float: right; margin-top: 25px">
				<a href="<%=cp%>/notice/notice.do">더보기</a>
			</div>
			...
			<div></div>
			<h3 class="glyphicon glyphicon-info-sign"> 이용방법</h3>
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="<%=cp%>/intro/intro.do">
				자세히</a><hr>

			<h3 class="glyphicon glyphicon-barcode"> 결제수단</h3><br>
			<div class="text-center">
				<img src="<%=cp%>/res/images/cash.png"><br><span>다양한 결제수단을 사용해 보세요</span>
			</div>
